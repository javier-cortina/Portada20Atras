...
import schedule
import time
from lib.constants import postElPais, postABC, postLaVanguardia, postMundoDeportivo, postElPaisSemanal, postTimeMagazine
from lib import elpais, abc, lavanguardia, mundodeportivo, elpaissemanal, timemagazine
...
def main():
    ...
    schedule.every().day.at(postTimeMagazine).do(timemagazine.tweetTimeMagazine)
